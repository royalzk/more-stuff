pcall(function()
    ...
    local W1 = OrionLib:MakeWindow({Name = "Furry Infection GUI ", HidePremium = false, SaveConfig = false, ConfigFolder = "Furry Infection GUI "})
    
    OrionLib:MakeNotification({
        Name = "Furry Infection GUI",
    ...
    Toggles:AddToggle({
        ...
        Callback = function(kaura)
            spawn(function()
                if kaura then
                    _G.killaura = true
                    notify("Furry Infection GUI","KillAura On ")
                else
                    _G.killaura = false
                    notify("Furry Infection GUI","KillAura Off ")
                end
    ...
    Toggles:AddToggle({
        ...
        Callback = function(autogetbatt)
            ...
            if autogetbatt then
                _G.getbatcrack = true
                notify("Furry Infection GUI","AutoGetBat On ")
            else
                _G.getbatcrack = false
                notify("Furry Infection GUI","AutoGetBat Off ")
            end
    ...
    if game.Players.LocalPlayer.Character:FindFirstChild("Bat") or game.Players.LocalPlayer.Backpack:FindFirstChild("Bat") or game.Players.LocalPlayer.Backpack:FindFirstChild("Metal  Bat") or game.Players.LocalPlayer.Character:FindFirstChild("Metal  Bat") then
        ...
        notify("Furry Infection GUI","Grabbed Bat ")
    end
    end) 
    end
    end)
    ...
    Toggles:AddToggle({
        ...
        Callback = function(lkillall)
            spawn(function()
                if lkillall then
                    _G.killall = true
                    notify("Furry Infection GUI","Loop Kill All On ")
                else
                    _G.killall = false
                    notify("Furry Infection GUI","Loop Kill All Off ")
                end 
        ...
        Callback = function(antigrabbed)
            spawn(function()
                if antigrabbed then
                    ...
                    notify("Furry Infection GUI","Auto Escape Grab On ")
               else 
                   _G.autoescapegrab = false
                   notify("Furry Infection GUI","Auto Escape Grab Off ")
                end
        ...
        Callback = function(lesscd)
            spawn(function()
                if lesscd then
                    ...
                    notify("Furry Infection GUI","Less Cooldown On ")
                else
                    _G.lesscooldown = false
                    notify("Furry Infection GUI","Less Cooldown Off ")
                end 
            end)
        end
    })
